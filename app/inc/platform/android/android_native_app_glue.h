...
struct android_app {
  ...
  // APP_CMD_SAVE_STATE, at which point they will be initialized to NULL and you
  // can malloc your state and place the information here.  In that case the
  // memory will be freed for you later.
  void *savedState;
